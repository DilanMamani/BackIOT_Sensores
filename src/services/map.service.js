...
/**
 * Reportes ciudadanos con coordenadas, filtrados por rango de tiempo.
 * Para admin devuelve todo; para ciudadano solo la semana actual.
 */
const getReportsForMap = async ({ range = '7d', role = 'ciudadano' }) => {
  // El ciudadano solo puede ver la semana actual como máximo
...
/**
 * Dispositivos con ubicación, estado y alertas abiertas recientes.
 * Solo para admin.
 */
...
/**
 * Alertas abiertas recientes para un conjunto de dispositivos.
 * Solo para admin.
 */
...
/**
 * Alertas (solo level + device_code) para ciudadano – sin datos internos.
 */
